...
Output
------
  pics/python/rscp_public_private_sector.pdf
  pics/python/rscp_public_private_distribution.pdf
  latex/texparts/python/rscp_public_private_sector.tex
  latex/texparts/python/rscp_public_private_distribution.tex
...
fig_a.tight_layout()
savefig(fig_a, "rscp_public_private_sector", out_dir=LATEX_PICS_DIR)
save_figure_tex(
    "rscp_public_private_sector",
    caption=(
    ...
    cite_keys="mpsv_ispv",
    label="fig:rscp_public_private_sector",
...
fig_b.tight_layout()
savefig(fig_b, "rscp_public_private_distribution", out_dir=LATEX_PICS_DIR)
save_figure_tex(
    "rscp_public_private_distribution",
    caption=(
    ...
    cite_keys="mpsv_ispv",
    label="fig:rscp_public_private_distribution",
