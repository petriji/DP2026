...
Output
------
  pics/python/ipp_ca_breadth.pdf
  latex/texparts/python/ipp_ca_breadth.tex

Run
---
    python analyses/ipp_ca_breadth.py
"""
...
out_pdf = savefig(fig, "ipp_ca_breadth", out_dir=LATEX_PICS_DIR)
