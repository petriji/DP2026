...
Output
------
  pics/python/strike_activity.pdf
  latex/texparts/python/strike_activity.tex

Run
---
    python analyses/strike_activity.py
"""
...
savefig(fig, "strike_activity", out_dir=LATEX_PICS_DIR)
