...
Output
------
  pics/python/self_employment_map.pdf
  latex/texparts/python/self_employment_map.tex

Run
---
    python analyses/self_employment_map.py
"""
...
# ── 4. Save figure ────────────────────────────────────────────────────────────
savefig(fig, "self_employment_map", out_dir=LATEX_PICS_DIR)
