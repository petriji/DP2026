...
Output
------
  pics/python/old_age_dependency_map.pdf
  latex/texparts/python/old_age_dependency_map.tex  ← \input{} this in main.tex

Run
---
    python analyses/old_age_dependency_map.py
"""
...
# ── 4. Save figure ────────────────────────────────────────────────────────────
savefig(fig, "old_age_dependency_map", out_dir=LATEX_PICS_DIR)
