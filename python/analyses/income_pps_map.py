...
Output
------
  pics/python/income_pps_map.pdf
  latex/texparts/python/income_pps_map.tex  ← \input{} this in main.tex

Run
---
    python analyses/income_pps_map.py
"""
...
# ── 4. Save figure ────────────────────────────────────────────────────────────
savefig(fig, "income_pps_map", out_dir=LATEX_PICS_DIR)
