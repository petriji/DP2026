...
Souhrnné srovnání čtyř analyzovaných smluv lze nejsnáze provést ve třech dimenzích -- mzdové základny, výše nárokových příplatků a~rozsahu nadstandardních benefitů.
...
\begin{enumerate}
  ...
  \item komparace prokazuje nezastupitelnost odvětvového vyjednávání. Podniková ujednání nedokáží kompenzovat chybějící sektorový standard v~odvětvích s~vysokou fragmentací a~nízkou odborovou organizovaností, jako je maloobchod. Výsledky tak podporují hlavní hypotézu o~přínosu sociálního dialogu k~sdílení rizik.
\end{enumerate}\par
