...
Případové studie navazují na~komparativní rovinu a~na~empirickou analýzu agregovaných ukazatelů z~kap.~\ref{sec:eu_pokryti_kv}.
...
\Acf{PKS} \emph{Penny~Market} a~\acs{PKS} \emph{Česká~pošta} reprezentují dva odlišné případy podnikového vyjednávání v~\acloc{ČR} -- soukromý maloobchodní řetězec se~zahraničním vlastníkem a~státní podnik s~koexistencí devíti \aclpgen{OO}.\par
Na~odvětvové úrovni je analyzována \acf{KSVS} v~zemědělství, jejíž závaznost byla rozšířena Sdělením č.~47/2026~Sb.~na~zaměstnavatele s~převažující činností v~\acloc{NACE}~01.1 až~01.6 a~je tak jednou ze čtyř \acs{KSVS} aktuálně závazných pro další zaměstnavatele, které se vztahují na asi 10~\% zaměstnanců.~\cite{sdeleni_47_2026}\par
