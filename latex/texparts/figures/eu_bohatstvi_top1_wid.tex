...
\def\strEuBohatstviTopIWidTitle{Podíl top 1\,\% domácností na čistém jmění (WID, 2024)}%
\def\strEuBohatstviTopIWidColorbarLabel{podíl top 1\,\% na čistém jmění [\%]}%
\def\strEuBohatstviTopIWidCaption{Podíl top 1\,\% domácností na čistém jmění, mapa Evropy, 2024. Zdroj~dat: \acs{WID}~\cite{wid_world_shweal}.}%
%
