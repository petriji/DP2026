...
\paragraph{Pokrytí \acs{KS} a~odborová organizovanost}\label{par:plsk_pokryti}
...
po~rychlé konvergenční fázi 1995--2008 se~tempo dohánění EU-27 zpomalilo
a~ekonomiky uvízly přibližně na~\SI{75}{\percent}--\SI{85}{\percent} úrovně
\acgen{HDP} \acs{geo-EU27} v~\acs{PPS}, aniž by~se~jim~dařilo přejít k~modelu
...
Giniho koeficientů v~\acs{geo-EU27} ($\approx 0{,}22$), což je~dáno relativně
