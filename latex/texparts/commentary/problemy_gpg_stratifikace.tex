Mzdová stratifikace podle pohlaví a~vzdělání (hodinové výdělky v~\ac{PPS}, po korekci cenovou hladinou) ukazuje, že \ac{GPG} v~ČR není homogenní: je výrazně větší u~středoškolsky vzdělaných pracovníků než u~vysokoškolsky vzdělaných, a~ve zpracovatelském průmyslu výrazněji než v~ICT nebo financích.
...
Hodinové výdělky podle pohlaví a~percentilu (1.~decil, medián, 9.~decil) pocházejí ze strukturálního šetření výdělků Eurostatu~\cite{eurostat_ses_hourly}.\par
