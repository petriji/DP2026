...
\begin{description}
  ...
  \item[Pokrytí \ac{KV} vs.\ čistý příjem (PPS)]
    Kladná panelová asociace dokládá, že vyšší pokrytí \ac{KS} je spojeno s~vyšším absolutním čistým příjmem v~PPS.
  ...
  \item[Pokrytí \ac{KV} vs.\ produktivita práce (PPS/h)]
    Kladná asociace mezi pokrytím \ac{KS} a~nominální produktivitou práce na odpracovanou hodinu (EU27\,=\,100) je konzistentní s~teorií, podle níž koordinované mzdové vyjednávání vytváří tlak na růst produktivity: firmy pokryté odvětvovou \ac{KS} nemohou kompenzovat vyšší mzdové náklady snížením mezd, a~proto investují do kapitálové vybavenosti a~inovací.
    ČR se v~tomto panelu nachází pod průměrem EU27 jak v~produktivitě, tak v~pokrytí; hypotetické posílení \ac{KV} by mohlo působit jako institucionální páka pro produktivitní konvergenci.
...
Produktivita práce (EU27\,=\,100)  & \multicolumn{4}{c}{\textit{hodnoty budou doplněny po přepočtu}} \\
\bottomrule
\end{tabular}
\end{table}
