...
Vysoká inter-sektorová disperze v~ČR má reálné sociální důsledky: pracovníci v~obchodu a~pohostinství --- skupiny s~vysokým podílem žen a~nízkokvalifikovaných --- jsou mzdově vytlačeni do in-work poverty territory (srov.~obr.~\ref{fig:stav_arope_mapa_2025}).
