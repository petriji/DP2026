...
Plná čára (celková podnikatelská sféra) zakrývá tuto heterogenitu a~může vytvářet falešný dojem koordinovaného vývoje; pohled na jednotlivá odvětví ukazuje, že „průměrný nárůst” v~ČR je artefaktem statistické agregace, nikoli výsledkem koordinace prostřednictvím \aclgen{KV}.
...
Meziroční nárůst \acs{LCI} podle odvětví \acs{NACE} vychází z~harmonizovaného indexu mzdových nákladů Eurostatu.\par

\input{texparts/python/problemy_sektor_lci}
