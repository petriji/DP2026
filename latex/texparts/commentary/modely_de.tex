...
\paragraph{Uspořádání modelu}\label{par:de_architektura}
...
\paragraph{Pokrytí \acs{KS} a~odborová organizovanost}\label{par:de_pokryti}
...
\Ac{ČR} sdílí s~Německem strukturu ekonomiky orientované na~průmyslový
