...
\paragraph{Uspořádání německého modelu}\label{par:de_architektura} stojí na~třech vzájemně propojených pilířích: ústavně
...
\paragraph{Pokrytí \acs{KS} v~Německu}\label{par:de_pokryti} dlouhodobě klesá: ze~zhruba \SI{85}{\percent}
...
Odborová organizovanost paralelně klesá pod \SI{16}{\percent} (obr.~\ref{fig:eu_hustota_mapa}).
...
\paragraph{Klíčové rysy německého modelu}\label{par:de_rysy} zahrnují pozdě zavedenou zákonnou minimální mzdu i~hlubokou podnikovou participaci. Zákonná minimální mzda byla zavedena teprve v~roce~2015
(\textit{Mindestlohngesetz}); do~té doby bylo mzdové minimum stanovováno výlučně
...
straně koordinované \acs{KV} a~\textit{Mitbestimmung} představují mechanismus
pro~strukturovanou rekvalifikaci a~spravedlivé rozdělení
produktivních zisků.

\paragraph{Implikace pro~\acacc{ČR}}\label{par:de_implikace} vycházejí z~toho, že~\ac{ČR} sdílí s~Německem strukturu ekonomiky orientované na~průmyslový
...
schopnost trhu práce zvládat vlny automatizace, aniž by~vyžadovalo
