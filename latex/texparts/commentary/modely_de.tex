...
radách~\cite{Hala_SystemySocialnihoDialogu2013}\cite{Petricek_PS2_NemeckyModel_2019}.
...
sociálními dopady~\cite{Petricek_PS2_NemeckyModel_2019}.
...
\SI{55}{\percent} na~západě)~\cite{Schulten_WSI_Tarifstaerkung_2024}\cite{OECD_UnionEmployerCoverage_2025}.
...
a~osobní služby~\cite{Schulten_WSI_Tarifstaerkung_2024}. V~reakci na~tento
...
\acs{KS}~\cite{Bundestag_EU6_013_26}.
...
a~stabilnější mzdový vývoj v~období hospodářských šoků~\cite{Hala_SystemySocialnihoDialogu2013}.
...
(\emph{working poor})~\cite{Petricek_PS2_NemeckyModel_2019}. Současná
debata Bundestagu se~zabývá kompenzací těchto dopadů skrze posílení \acs{KV}
a~regulaci platformové práce~\cite{Bundestag_EU6_013_26}.
...
produktivních zisků~\cite{Weber_Industrie40_2015}.
