Odborová organizovanost v~ČR prošla od roku 1993 dramatickým poklesem: z~přibližně \SI{70}{\percent} v~době transformace na současných asi \SI{11}{\percent}, přičemž trend není zastaven a~ČR se přibližuje hodnotám typickým pro Francii (\SI{8}{\percent}), kde je však nízká organizovanost kompenzována zákonným rozšiřováním závaznosti \ac{KS} na celé odvětví.
...
Rakousko a~Dánsko udržují hustotu na \SIrange{55}{65}{\percent}, přičemž právě tyto země vykazují nejnižší mzdovou disperzí a~nejvyšší podíl pracovníků pokrytých kolektivní smlouvou --- doklady pro kauzalitu ve smyslu Freemana a~Medoffa (1984).
