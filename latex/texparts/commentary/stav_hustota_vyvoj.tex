Hustota odborových organizací v~ČR prošla od roku 1993 dramatickým poklesem: z~přibližně \SI{70}{\percent} v~době transformace na současných asi \SI{11}{\percent}, přičemž trend není zastaven a~ČR se přibližuje hodnotám typickým pro Francii (\SI{8}{\percent}), kde je však nízká hustota kompenzována zákonným rozšiřováním závaznosti \ac{KS} na celé odvětví~\cite{oecd_aias_ictwss_TUD_pct}.
