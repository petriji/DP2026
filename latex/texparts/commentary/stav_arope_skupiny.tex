Srovnání míry \ac{AROPE} podle skupin zemí (Severní Evropa, ZE, Visegrád) zdůrazňuje, že skupinová příslušnost k~modelu trhu práce je silnějším prediktorem \ac{AROPE} než samotná výše \ac{HDP}: severské země s~koordinovanými mzdovými systémy a~silnou \ac{APZ} dosahují hodnot pod \SI{15}{\percent}, zatímco Visegrád osciluje kolem \SIrange{20}{30}{\percent}~\cite{eurostat_ilc_peps01n_PC_pop}.
