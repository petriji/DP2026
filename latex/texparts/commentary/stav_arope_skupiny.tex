...
Skupinový přístup dále ukazuje divergenci uvnitř \acgen{V4}: po~finanční krizi 2008 a~po~pandemii Covid-19 se Polsko a~Maďarsko přibližovaly k~průměru \acs{geo-EU27}, zatímco český vývoj stagnuje na relativně nízké, ale strukturálně zranitelné úrovni.
...
\input{texparts/python/stav_arope_skupiny}
