...
\begin{itemize}
  \item \textbf{Pokrytí \ac{KV} vs.~pracovní doba} ($\acs{var-r} = -0{,}483$; $\acs{var-rho} = -0{,}525$):
  ...
  \item \textbf{Pokrytí \ac{KV} vs.~\ac{HDP}/ob.~(\ac{PPS})} ($\acs{var-r} = 0{,}566$; $\acs{var-rho} = 0{,}472$):
  ...
  \item \textbf{Pokrytí \ac{KV} vs.~Gini} ($\acs{var-r} = -0{,}303$; $\acs{var-rho} = -0{,}238$):
    ...
    Průřezová hodnota $\acs{var-r}_{2024} = +0{,}481$ je kladná, což na první pohled odporuje teorii mzdové komprese; vysvětlení je institucionální: v~průřezu roku 2024 mají státy s~erga omnes pokrytím (FR, IT, BE, AT, ES --- všechny $\geq 90\,\%$) vyšší disponibilní Gini než řada středoevropských zemí s~nízkým pokrytím, a~to proto, že jejich Gini disponibilního příjmu je taženo nahoru vysokými kapitálovými příjmy a~odměnami ve finančním sektoru, nikoliv absencí mzdové komprese.
  ...
  \item \textbf{Pokrytí \ac{KV} vs.~příjdem/\ac{HDP}} ($\acs{var-r} = 0{,}210$; $\acs{var-rho} = 0{,}177$):
  ...
  \item \textbf{Hustota odborů vs.~Gini} ($\acs{var-r} = -0{,}458$; $\acs{var-rho} = -0{,}462$):
    ...
    Průřezová korelace $\acs{var-r}_{2024} = -0{,}627$ dosáží \emph{silné záporné} asociace (Evans: $0{,}60$--$0{,}79$), výrazně posilující celkový závěr: v~roce 2024 je hustota odborů nejsilnjším institucionálním prediktorem nízkého Gini ze všech testovaných párů.
