...
Čistý hod.~příjem (\si{\pps\per\hour})  & $9{,}91$ & $+0{,}079$ & $+3{,}90$ & $13{,}81$ \\
...
\begin{itemize}
  \item nárůst čistého hodinového příjmu o~\SI{3,90}{\pps\per\hour} ($+39\,\%$) by ČR přiblížil aktuální úrovni Slovinska nebo Španělska;
  \item zkrácení průměrné skutečné pracovní doby o~\SI{2,1}{\hour\per\week} při vyšším příjmu odpovídá přibližně jednomu dni volna za 14~dní;
