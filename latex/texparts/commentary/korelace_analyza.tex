...
\begin{description}
  ...
  \item[Pokrytí \ac{KV} vs.\ hodinový příjem (PPS/h)]
...
Ukazatel
  ...
  & Predikce $\hat{y}_1$ \\
\midrule
Průměrná skut.~prac.~doba (h/týden) & $37{,}5$ & $-0{,}042$ & $-2{,}1$  & $35{,}4$ \\
Gender pay gap (\%)                  & $18{,}5$ & $-0{,}023$ & $-1{,}1$  & $17{,}4$ \\
Čistý hod.~příjem (PPS/h)           & $9{,}91$ & $+0{,}079$ & $+3{,}90$ & $13{,}81$ \\
...
\begin{itemize}
  \item nárůst čistého hodinového příjmu o~$+3{,}90$~PPS/h ($+39\,\%$) by ČR přiblížil aktuální úrovni Slovinska nebo Španělska;
  \item zkrácení průměrné skutečné pracovní doby o~$2{,}1$~h/týden při vyšším příjmu odpovídá přibližně jednomu dni volna za 14~dní;
  \item snížení gender pay gap o~$1{,}1$~pp je malé, ale směr je konzistentní s~hypotézou o~standardizačním efektu \ac{KV} na mzdové tarify.
\end{itemize}
