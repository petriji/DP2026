...
\begin{tikzpicture}[node distance=6mm and 7mm]
  ...
  \node[pipebox,right=of outputs] (latex) {\texttt{main.tex}\\commentary};
...
ty, které byly vynuceny volbou \texttt{--force}.
...
latexmk -pdf -interaction=nonstopmode -file-line-error -outdir=build python_pipeline_attachment.tex
\end{pipelinecode}
